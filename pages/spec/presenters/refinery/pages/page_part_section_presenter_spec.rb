  ...
  module Pages
    describe PagePartSectionPresenter do
      ...
      it "marks the body as html safe" do
        ...
        section = PagePartSectionPresenter.new(part)
        section.wrapped_html.should == "<div id=\"-wrapper\" class=\"section-wrapper\"><div class=\"inner\"><section class=\"section\"><div class=\"inner\"><p>part_body</p></div></section></div></div>"
      end
      ...
      it "handles a nil page body" do
        ...
        section.has_content?.should be_falsey
      end
