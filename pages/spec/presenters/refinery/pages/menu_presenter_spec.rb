    ...
    describe MenuPresenter do
      ...
      describe "#to_html" do
        it "returns menu items wrapped in html" do
          ...
          menu_presenter = MenuPresenter.new(menu_items, view)
          expect(menu_presenter.to_html).to eq(%Q{<nav class="menu clearfix" id="menu" role="navigation"><ul class="nav"><li class="first last"><a href="/refinery-cms">Refinery CMS</a></li></ul></nav>})
        end
      end
