...
refinery.admin.pages_dialog.link_to.insert in pages/app/views/refinery/admin/pages_dialog/link_to.html.erb     is not in any nl locale file
Number of missing translations for nl: 2
</pre>

As you can see, there are two missing keys: +refinery.admin.pages.form_advanced_options.page_options+ and +refinery.admin.pages_dialog.link_to.insert+.
...
The key +refinery.admin.pages_dialog.link_to.insert+ is represented in YAML like so:
