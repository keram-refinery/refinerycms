module Refinery
  class PasswordsController < Devise::PasswordsController
    ...
    def edit
      reset_password_token = Devise.token_generator.digest(nil, :reset_password_token, params[:reset_password_token].to_s)
      self.resource = Refinery::User.find_by(reset_password_token: reset_password_token)
