...
this.bind_events(),this.init_buttons(),this.is({initialised:!0,initialising:!1}),this.trigger("init"));return this}})})(refinery);(function(d){d.Object.create({name:"Picker",module:"admin",elm_current_record_id:null,elm_record_holder:null,elm_no_picked_record:null,elm_remove_picked_record:null,dialog:null,open:function(){this.dialog.open();return this},close:function(){this.dialog.close();return this},insert:function(a){d.log(a);return this},destroy:function(){this.dialog&&this.dialog.destroy();return this._destroy()},bind_events:function(){var a=this,c=a.holder;a.dialog.on("insert",function(b){a.insert(b)});c.find(".current-record-link").on("click",
function(b){b.preventDefault();a.open()});c.find(".remove-picked-record").on("click",function(b){b.preventDefault();a.elm_current_record_id.val("");a.elm_record_holder.empty();a.elm_remove_picked_record.addClass("hide");a.elm_no_picked_record.removeClass("hide");a.trigger("remove")})},init_dialog:function(){},init:function(a){this.is("initialisable")&&(this.is("initialising",!0),this.attach_holder(a),this.elm_current_record_id=a.find(".current-record-id"),this.elm_record_holder=a.find(".record-holder"),
