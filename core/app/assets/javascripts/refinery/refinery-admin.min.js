...
function(a){a.preventDefault();d.dialog({title:t("refinery.admin.form_page_parts_add_part_dialog_title"),Z:!0,$:!1,S:!0,width:400,height:240});d.removeClass("hide")});b.on("click",function(a){a.preventDefault();c.o(b.attr("href"))});d.on("click",".cancel-button",function(a){a.preventDefault();d.dialog("close");e.val("")});d.on("click",".submit-button",function(b){b.preventDefault();c.k(a.attr("href"),e)});e.keypress(function(b){13===b.which&&(b.preventDefault(),c.k(a.attr("href"),e))})},r:function(){var a=
