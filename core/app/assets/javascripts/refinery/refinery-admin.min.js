...
d,c)}var b=this,c=$(window),d=b.holder.find(".form-actions"),e=b.holder.find(".form-actions-left");0<b.holder.find("textarea").length&&(0<d.length&&0<e.length)&&(b.l(e,d,c),c.on("scroll",a),b.on("destroy",function(){c.unbind("scroll",a)}))},init:function(a){this.is("initialisable")&&(this.is("initialising",!0),refinery.Object.attach(this.uid,a),this.holder=a,this.C(),this.A(),this.m=a.serialize(),this.w(),this.is({initialised:!0,initialising:!1}),this.trigger("init"));return this}});
refinery.admin.ui.form=function(a){a.find("form").each(function(){refinery("admin.Form").init($(this))})};refinery.Object.create({name:"FormPageParts",module:"admin",q:"#menu, #add-page-part, #delete-page-part, .locale-picker, .field:not(:has(#page-tabs)), #page-part-editors, #more-options-field, .form-actions",o:function(a){var b=this,c=b.holder,d=c.tabs("option","active"),e=b.b.find(".ui-state-active a").text(),f=$("#page_parts_attributes_"+d+"_id");confirm(t("refinery.admin.form_page_parts_remove",{title:e}))&&(c.find(".ui-tabs-nav li:eq("+d+")").remove(),c.find(".ui-tabs-panel:eq("+d+")").remove(),
...
function(a){a.preventDefault();d.dialog({title:t("refinery.admin.form_page_parts_add_part_dialog_title"),$:!0,aa:!1,S:!0,width:400,height:240});d.removeClass("hide")});b.on("click",function(a){a.preventDefault();c.o(b.attr("href"))});d.on("click",".cancel-button",function(a){a.preventDefault();d.dialog("close");e.val("")});d.on("click",".submit-button",function(b){b.preventDefault();c.k(a.attr("href"),e)});e.keypress(function(b){13===b.which&&(b.preventDefault(),c.k(a.attr("href"),e))})},r:function(){var a=
...
[a]);return this},init:function(a){this.is("initialisable")&&(this.is("initialising",!0),this.holder=a,this.b=a.find("#page-parts"),this.r(),this.D(),refinery.Object.attach(this.uid,a),this.is({initialised:!0,initialising:!1}),this.trigger("init"));return this}});refinery.admin.ui.formPageParts=function(a,b){a.find("#page-tabs").each(function(){var c=refinery("admin.FormPageParts").init($(this));c.on("part:add",function(){b.reload(a)});c.on("part:delete",function(){b.reload(a)})})};refinery.Object.create({objectConstructor:function(a,b){var c=this;refinery.Object.apply(c,arguments);b||(c.options.nested_sortable.stop=function(a,b){c.options.update_url&&c.update(b.item)})},name:"SortableList",module:"admin",options:{update_url:null,redraw:!0,nested_sortable:{X:"ul",J:"li",Y:1}},set:null,html:null,g:function(a){return a.attr("id")&&/([0-9]+)$/.test(a.attr("id"))?a.attr("id").match(/([0-9]+)$/)[1]:null},update:function(a){var b=this,c=b.holder,d=c.nestedSortable("toArray");a={item:{id:b.g(a),
...
b.is("updating",!1);c.nestedSortable("enable")}));return b},destroy:function(a){this.holder.nestedSortable("destroy");this.set=null;refinery.Object.prototype.destroy.apply(this,[a]);return this},init:function(a){this.is("initialisable")&&(this.is("initialising",!0),a.nestedSortable(this.options.nested_sortable),refinery.Object.attach(this.uid,a),this.set=a.nestedSortable("toArray"),this.html=a.html(),this.holder=a,this.is({initialised:!0,initialising:!1}),this.trigger("init"));return this}});
