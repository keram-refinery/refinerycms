(function(window, $){'use strict';(function(){function d(){return d.d.apply(d,arguments)}"undefined"===typeof Turbolinks&&(window.g={visit:function(a){document.location.href=a}});d.d=function(a,b,c){a=a.split(".");for(var e=this;a.length;)e=e[a.shift()];return new e(b,c)};d.extend=function(a,b){for(var c in b)b.hasOwnProperty(c)&&!a.hasOwnProperty(c)&&(a[c]=b[c]);return a};d.flash=function(a,b){var c=$("#flash-wrapper").empty(),c=$("<div/>",{"class":"flash flash-"+a,html:b}).appendTo(c);0===c.find(".flash-close").length&&
...
"."+a,b);return this},destroy:function(){this.holder&&(this.holder.unbind(),this.detach_holder());this.state=null;d.Object.instances.remove(this.uid);this.trigger("destroy");this.events={};return this},_destroy:function(){return d.Object.prototype.destroy.apply(this,arguments)},attach_holder:function(a){var b=a.data("refinery-instances")||[];a.data("refinery-instances",b.concat(this.uid));a.addClass("refinery-instance");this.holder=a},detach_holder:function(){var a=this.holder,b=a.data("refinery-instances")||
[],c=this.uid;a.data("refinery-instances",b.filter(function(a){return a!==c}));0===a.data("refinery-instances").length&&a.removeClass("refinery-instance");this.holder=null},init:function(a){this.is("initialisable")&&(this.holder=a,this.is("initialised",!0),this.trigger("init"));return this}};d.Object.guid=0;d.Object.create=function(a){var b,c,e,f=["objectPrototype","objectConstructor","objectMethods","id","uid"];a=a||{};e=a.objectMethods;b=a.objectConstructor||function(a,c){d.Object.call(this,a,c)};
...
{};return{all:function(){return a},add:function(b){a[b.uid]=b},get:function(b){return a[b]},remove:function(b){delete a[b]}}}()})(refinery);(function(d){d.Object.create({name:"UserInterface",options:{main_content_selector:"#content"},b:function(){var a=this,b=a.holder;b.on("click",".flash-close",function(a){a.preventDefault();$(this).parent().fadeOut();return!1});b.on("ajax:success",function(c,e,f,h){var l=h.getResponseHeader("X-XHR-Redirected-To"),k=!0;e&&"object"===typeof e&&(e.redirect_to?Turbolinks.visit(e.redirect_to):(l||"a"===c.target.tagName.toLowerCase()?(c=b.find(a.options.main_content_selector),k=!1):c=$(c.target),a.destroy(),
d.xhr.success(e,f,h,c,k),a.trigger("ui:change")))});b.on("ajax:error",function(a,b,f){d.xhr.error(b,f)})},c:function(){var a=this.holder,b=d.ui,c;for(c in b)if(b.hasOwnProperty(c)&&"function"===typeof b[c])b[c](a,this)},destroy:function(){var a=this.holder;if(a){a=a.find(".refinery-instance");try{a.each(function(){for(var a=$(this).data("refinery-instances"),b,f=a.length-1;0<=f;f--)b=d.Object.instances.get(a[f]),b.destroy()})}catch(b){"object"===typeof console&&"function"===typeof console.log&&(console.log(b),
console.log(a))}}return this._destroy()},init:function(a){this.is("initialisable")&&(this.is("initialising",!0),this.attach_holder(a),this.b(),this.c(),this.is({initialised:!0,initialising:!1}),this.trigger("init"));return this}})})(refinery);}(window, jQuery));
