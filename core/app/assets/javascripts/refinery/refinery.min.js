...
{};return{all:function(){return a},add:function(b){a[b.uid]=b},get:function(b){return a[b]},remove:function(b){delete a[b]}}}()})(refinery);(function(d){d.Object.create({name:"UserInterface",options:{main_content_selector:"#content"},b:function(){var a=this,b=a.holder;b.on("click",".flash-close",function(a){a.preventDefault();$(this).parent().fadeOut();return!1});b.on("ajax:success",function(c,e,f,h){var l=h.getResponseHeader("X-XHR-Redirected-To"),k=!0;c=c.target;e.redirect_to?Turbolinks.visit(e.redirect_to):(l||"a"===c.tagName.toLowerCase()?(c=b.find(a.options.main_content_selector),k=!1):c=$(c),a.destroy(),d.xhr.success(e,f,h,c,k),
a.trigger("ui:change"))});b.on("ajax:error",function(a,b,f){d.xhr.error(b,f)})},c:function(){var a=this.holder,b=d.ui,c;for(c in b)if(b.hasOwnProperty(c)&&"function"===typeof b[c])b[c](a,this)},destroy:function(){var a=this.holder;if(a){a=a.find(".refinery-instance");try{a.each(function(){for(var a=$(this).data("refinery-instances"),b,f=a.length-1;0<=f;f--)b=d.Object.instances.get(a[f]),b.destroy()})}catch(b){d.log(b)}}return this._destroy()},init:function(a){this.is("initialisable")&&(this.is("initialising",
!0),this.attach_holder(a),this.b(),this.c(),this.is({initialised:!0,initialising:!1}),this.trigger("init"));return this}})})(refinery);}(window, jQuery));
