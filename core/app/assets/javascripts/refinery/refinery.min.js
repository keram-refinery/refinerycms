(function(window, $){'use strict';(function(){function d(){return d.b.apply(d,arguments)}d.b=function(a,b,c){a=a.split(".");for(var e=this;a.length;)e=e[a.shift()];return new e(b,c)};d.extend=function(a,b){for(var c in b)b.hasOwnProperty(c)&&!a.hasOwnProperty(c)&&(a[c]=b[c]);return a};d.flash=function(a,b){var c=$("#flash-wrapper").empty(),c=$("<div/>",{"class":"flash flash-"+a,html:b}).appendTo(c);0===c.find(".flash-close").length&&$("<a/>",{"class":"flash-close",text:"close",href:"#"}).appendTo(c)};d.validator={email:RegExp(/^([a-z0-9_\.\-]+)@([\da-z\.\-]+)\.([a-z\.]{2,6})$/i),
...
data:b,dataType:"JSON"}).fail(function(a,b){d.xhr.error(a,b)}).done(function(a,b,g){d.xhr.success(a,b,g,c)})},processHtml:function(a,b,c){for(var e=a.length-1;0<=e;e--)if("string"===typeof a[e]&&0<b.length)c?b.replaceWith(a[e]):b.html(a[e]);else for(var f in a[e])a[e].hasOwnProperty(f)&&d.d(f,a[e][f])},processMessage:function(a){var b=$("#flash-wrapper").empty(),c;if("object"===typeof a)for(c in a)a.hasOwnProperty(c)&&b.append(a[c]);else b.append(a)},error:function(a,b){var c='<b class="'+b+'">'+
