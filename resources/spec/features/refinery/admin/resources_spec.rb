    ...
    describe 'Resources' do
      ...
      context 'new/create' do
        it 'uploads file' do
          ...
          page.should have_selector 'form#new_resource'
        ...
        describe 'max file size' do
          ...
          context 'in english' do
            before do
              logged_in_user.stub(:locale).and_return(:en)
            end
          ...
          context 'in danish' do
            before do
              logged_in_user.stub(:locale).and_return(:da)
            end
      ...
      context 'edit/update' do
        ...
        it 'updates file' do
          visit refinery.admin_resources_path
          page.should have_content('Refinery Is Awesome.txt')
          page.should have_selector("a[href='/#{Refinery::Core.backend_route}/resources/#{resource.id}/edit']")
          ...
          attach_file 'resource_file', Refinery.roots(:'refinery/resources').join('spec/fixtures/updated/refinery_is_awesome.txt')
          click_button 'Save'

          page.should have_content("File 'Refinery Is Awesome' was successfully updated.")
          Refinery::Resource.count.should == 1

          click_link 'Download this file'

          page.should have_content('http://refinerycms.com')
        end
      end
      ...
      context 'destroy' do
        ...
        it 'removes file' do
          visit refinery.admin_resources_path
          page.should have_selector("a[href='/#{Refinery::Core.backend_route}/resources/#{resource.id}']")
